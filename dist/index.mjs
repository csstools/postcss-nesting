import require$$0 from 'cssesc';
import require$$4 from 'util-deprecate';

// see : https://www.w3.org/TR/css-nesting-1/#mixing
function ensureCorrectMixingOfNestingRulesAndDeclarations(node) {
...
var _cssesc = _interopRequireDefault(require$$0);
